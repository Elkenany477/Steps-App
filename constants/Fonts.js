 ...
 */
const customFonts = {
    'avenir-next-regular': require('../fonts/avenir-next-regular.ttf'),
    'avenir-next-medium': require('../fonts/avenir-next-medium.ttf'),
    'avenir-next-demi': require('../fonts/avenir-next-demi.ttf'),
    'avenir-next-bold': require('../fonts/avenir-next-bold.ttf'),
    'Ubuntu-Medium': require('../fonts/Ubuntu-Medium.ttf'),
    'Montserrat-Italic': require('../fonts/Montserrat-Italic.ttf'),
    'GreatVibes-Regular': require('../fonts/GreatVibes-Regular.ttf'),
};
const type = {
